...
export default function Login() {
    ...
    const assignedProject = params.get("project") || "";
    ...
    const handleLogin = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:3001/auth/login', { email, assignedProject }, { withCredentials: true })
            ...
            toast.error('Login failed. Try again.', err?.error);
        }
        setLoading(false)
    }
    return (
        <div className='w-full h-[100vh] flex justify-center items-center '>
            <div className="max-w-[400px] shadow-lg p-7 min-w-[300px]">
                ...
                <h2 className='text-center font-bold mt-2'>Log in to continue</h2>
